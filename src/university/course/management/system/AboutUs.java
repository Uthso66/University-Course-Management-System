...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("university/course/management/system/icons/logo.jpg"));
            ...
            JLabel l6 = new JLabel("Developed By : Suprodip Sorkar & \n Tarikul Islam");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 25));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Roll Number - 2017331062 & 2017331066");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact : suprodipsorkar@gmail.com, tarikulislam.uthso.3966@gmail.com");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 15));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Education - B.Sc (Computer Science & Engineering, SUST)");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel("Phone - 01719342241 & 01793898900");
