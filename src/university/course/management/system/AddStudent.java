...
class AddStudent implements ActionListener{
    ...
    public AddStudent(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("university/course/management/system/icons/fourth.jpg"));
	...
	lab.setFont(new Font("serif",Font.BOLD,20));
        ...
        String course[] = {"BBA","B.Sc","M.Sc","MBA","BA"};
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"CSE","EEE","Mechanical","Civil","PME"};
